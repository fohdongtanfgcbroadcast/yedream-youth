  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {activeClasses.map((cls) => {
        ...
        const classRecords = attendanceRecords.filter((a) =>
          members.some((m) => m.id === a.member_id && m.class_id === cls.id)
        );
            ...
            <Card style={styles.classCard}>
              <Card.Content style={styles.classRow}>
                ...
                <View style={styles.classInfo}>
                  ...
                  <Text style={styles.classCardDesc}>
                    {count}명 | 총 {totalPoints}점 | {cls.description || ''}
                  </Text>
                </View>
...
function MaterialIcon({ name }: { name: string }) {
  return <Text style={{ fontSize: 20, color: COLORS.textSecondary }}>›</Text>;
}
